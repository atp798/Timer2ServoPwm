...
#define MAX_PULSE_WIDTH       2430      // unit:us
...
#define MAX_SERVOS            8         // 20ms / 2.5ms = 8
...
public:
  ...
  // Similar as attach(int pin), but also sets min and max pluse width in microseconds.
